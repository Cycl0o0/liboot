 ...
 */
/* N64 Mtx words are always 32-bit. `long` is 64-bit on LP64 hosts, which
 * doubled this union to 128 bytes and split the integer/fraction halves at
 * the wrong offset when captured display-list matrices were replayed. */
